...
import 'package:viva_home_mobile/widgets/upload_image_card.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildOtherSpecifyField(
                      ...
                      hintText: "John…",
                      onSaved: (val) => formData["other_homeowner_name"] = val,
                    ),
                    buildCustomTextField(
                      ...
                      onChanged: (val) {
                        setState(() => hasFirstName = val!.trim().isNotEmpty);
                        _updateNodeWithConditions("det_gen_homeowner");
                      },
                      validator: ValidationUtils.required,
                    ),
                ...
                child: Column(
                  children: [
                    buildCustomTextField(
                      ...
                      hintText: "...",
                      onSaved: (val) => formData["address_line_1"] = val,
                      onChanged: (val) {
                        setState(
                    ...
                    buildCustomTextField(
                      ...
                      hintText: "...",
                      onSaved: (val) => formData["address_line_2"] = val,
                      onChanged: (val) {
                        setState(
                    ...
                    buildCustomTextField(
                      ...
                      onChanged: (val) {
                        setState(() => hasTown = val!.trim().isNotEmpty);
                        _updateNodeWithConditions("det_gen_proAddress");
                      },
                      validator: ValidationUtils.required,
                    ),
                    buildCustomTextField(
                      ...
                      onChanged: (val) {
                        setState(() => hasPostcode = val!.trim().isNotEmpty);
                        _updateNodeWithConditions("det_gen_proAddress");
                      },
                ...
                child: Column(
                  children: [
                    buildCustomTextField(
                      ...
                      onChanged: (val) {
                        setState(() => hasLocation = val!.trim().isNotEmpty);
                ...
                child: Column(
                  ...
                  children: [
                    buildComboBoxField(
                      ...
                      onChanged: (val) {
                        setState(() => hasOwnershipType = val!.isNotEmpty);
                        _updateNodeWithConditions("det_gen_tenure");
                      },
                      validator: ValidationUtils.required,
                      onSaved: (val) => formData["ownership_type"] = val,
                    ),
                    buildCustomTextField(
                      label: "Term Remaining (Years):",
                      hintText: "...",
                      keyboardType: TextInputType.numberWithOptions(),
                      onSaved: (val) => formData["term_remaining_years"] = val,
                      onChanged: (val) {
                        setState(() {
                          hasTermRemainingYears = val!.trim().isNotEmpty;
                        });
                        _updateNodeWithConditions("det_gen_tenure");
                      },
                      validator: ValidationUtils.number,
                    ...
                    buildRadioField<bool>(
                      ...
                      validator: ValidationUtils.validateRequiredOption<bool>,
                      onSaved: (val) =>
                          formData["has_ground_rent_service_charge"] = val,
                    ),
                    buildOtherSpecifyField(
                      context: context,
                      ...
                      onSaved: (val) =>
                          formData["other_ground_rent_service_charge"] = val,
                    ),
                  ],
                ),
              ),
                  ...
                  children: [
                    buildRadioField<String>(
                      ...
                      onChanged: (val) {
                        ...
                        _updateNodeWithConditions("det_gen_efficiences");
                      },
                      onSaved: (val) =>
                          formData["energyEfficienciesOption"] = val,
                      validator: (val) =>
                          ValidationUtils.validateRequiredOption<String>(val),
                    ),
                    buildOtherSpecifyField(
                      context: context,
                    ...
                    FormFieldGroup(
                      ...
                      items: [
                        ...
                        CustomTextField(
                          ...
                          colorBorder: AppColors.dark,
                          validator: ValidationUtils.required,
                          onSaved: (val) => formData["epc_rating"] = val,
                          onChanged: (val) {
                            setState(() => hasEpcNo = val!.trim().isNotEmpty);
                            _updateNodeWithConditions("det_gen_efficiences");
                          },
                        ),
                      ],
